        ...
        <header>
            <div class="site" id="top">
                ...
                <nav>    
                    ...
                    <ul id="menu">  
                                    <?php if (strpos(current_url(), base_url('aktuelles')) !== false) : $class = ' class="active"';
                                    else : $class = '';
                                    endif; ?>                
                        <li><a href="<?= base_url('aktuelles') ?>"<?= $class ?>>News</a>  
                            <div class="dropdown">  
                                ...
                                <ul>                   
                                    <?php if (current_url() == base_url('aktuelles/einsaetze')) : $class = ' class="active"';
                                    else : $class = '';
                                    endif; ?>      
                                ...
                                <ul>                         
                                    <?php if (current_url() == base_url('aktuelles/termine')) : $class = ' class="active"';
                                    else : $class = '';
                                    endif; ?> 
...
<?php endforeach; ?>
                                ...
                                <ul>
<?php if (current_url() == base_url('aktuelles/presse')) : $class = ' class="active"';
else : $class = '';
endif; ?>  
...
<?php endforeach; ?>                   
                                           ...
                                           <?php if (strpos(current_url(), base_url('menschen')) !== false) : $class = ' class="active"';
                                           else : $class = '';
                                           endif; ?>  
                            ...
                            <div class="dropdown">  
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?= base_url('menschen/leistungsgruppe#anker_praxis"') ?>>Praxis</a></li>
                                                ...
                                                <?php if (strpos(current_url(), base_url('technik')) !== false) : $class = ' class="active"';
                                                else : $class = '';
                                                endif; ?>                    
        ...
        <?php if ($f->name_lang != '') : echo $f->name . ' - ' . $f->name_lang;
        else : echo $f->name;
        endif; ?>
                                                            </a></li>  
        <?php
...
?>   
                                    ...
                                    <?php if (current_url() == base_url('informationen')) : $class = ' class="active"';
                                    else : $class = '';
                                    endif; ?> 
                                    ...
                                    <?php if (current_url() == base_url('verein')) : $class = ' class="active"';
                                    else : $class = '';
                                    endif; ?> 
