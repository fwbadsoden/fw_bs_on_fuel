...
$config['auto_validate_fields'] = array(
	'email|email_address' => array('valid_email', 'Bitte tragen Sie eine gültige Emailadresse ein.'),
	'phone|phone_number' => array('valid_phone', 'Bitte tragen Sie eine gültige Telefonnummer ein.')
);
...
$config['default_required_message'] = "Bitte füllen Sie das Pflichtfeld '%1s'"; // uses sprintf
