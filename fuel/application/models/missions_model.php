...
class Missions_model extends Abstract_module_model {
    ...
    public $has_many = array('mission_images' => 'mission_images_model');
    public $belongs_to = array('fahrzeuge' => 'fahrzeuge_model');    
    ...
    public function form_fields($values = array(), $related = array()) {
        ...
        $fields["einsatz_nr"]       = array('order' => 2);    
                                           
        $fields["name"]             = array('order' => 3); 
        
        $fields['datum_beginn']     = array('order' => 4); 
                                           
        $fields["uhrzeit_beginn"]   = array('order' => 5); 
                                                                     
        $fields['datum_ende']       = array('order' => 6);              
                                            
        $fields['uhrzeit_ende']     = array('order' => 7); 
        
        $fields["anzahl_kraefte"]   = array('label' => lang("form_label_einsatz_anzahl_kraefte"),
                                            'after_html' => 'Personen',
                                            'order' => 8);
        
        $fields["anzahl_einsaetze"] = array('order' => 9);
